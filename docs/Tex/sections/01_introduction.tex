...
Il costo complessivo del prototipo, comprensivo di microcontrollori, sensori, moduli GPS, cablaggi e alimentazione, è stimato in circa 90–100\,€, ampiamente al di sotto del limite imposto dal requisito non funzionale NFR10 NFR10 (\textit{costo $\leq 150\,\texteuro$}).
...
Il presente elaborato è organizzato secondo le fasi del \textbf{System Development Life Cycle (SDLC)} \cite{Pressman2019}, che fornisce una struttura metodologica per l’analisi, la progettazione, l’implementazione e la validazione di sistemi complessi.  
