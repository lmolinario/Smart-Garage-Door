...
\toprule
\textbf{FR} & \textbf{Descrizione} & \textbf{Input} & \textbf{Output} \\
\midrule
...
FR6 & Gestione multiutenza &
Richiesta di aggiunta o rimozione di utenti &
Aggiornamento dell’elenco degli utenti autorizzati \\

FR7 & Comando locale / override &
Intervento manuale &
Esecuzione immediata del comando \\

FR8 & Rilevazione ostacolo con riapertura &
Sensore ostacolo attivo &
Arresto e riapertura della porta \\

FR9 & Consultazione log essenziale &
Richiesta amministratore &
Elenco di eventi e azioni registrate \\
\bottomrule
\end{tabularx}
\end{table}
...
NFR2 & Prestazioni & Il tempo di risposta ai comandi e alle notifiche (latenza HTTP-escluso il tempo di attuazione fisica)deve essere inferiore a 1\,s (95° percentile). \\
