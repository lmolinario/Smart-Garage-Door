...
\hline
FR6 & Gestione fallback di rete & Cap. 4–5 & Test disconnessione Wi-Fi e riconnessione \\
\hline
...
\begin{table}[h!]
    ...
    NFR2 & Misura della latenza HTTP request/response tra comando utente e backend applicativo (esclusa attuazione fisica): 0.211 s (OPEN), 0.225 s (CLOSE), n=10. & OK \\
    NFR3 & AccAccuratezza del geofence: errore medio inferiore a 3--5 m e tasso di falsi positivi $<$ 1\% & OK \\ \hline
