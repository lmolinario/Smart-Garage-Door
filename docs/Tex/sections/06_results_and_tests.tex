...
\begin{table}[h!]
    ...
    FR5a - Robustezza & Introduzione di rumore artificiale sul pin PIR per simulare malfunzionamenti; test del filtro software (debounce); verifica dell'assenza di aperture spurie. & Superato \\ \hline
...
I meccanismi software adottati, basati su controllo temporale e verifica dello stato del
sistema, hanno impedito l’attivazione di eventi indesiderati, evitando aperture
