...
\node[layer, below=7mm of app] (net) {Network Layer};
\node[layer, below=7mm of net] (perc) {Perception Layer};

% --- COMPONENTS ---
% Application
\node[comp, below=2mm of app.north west, anchor=north west, xshift=5mm] (api) {API REST};
\node[comp, right=4mm of api] (dt) {Digital Twin (DR/CVO)};
\node[comp, right=4mm of dt] (tg) {Telegram Bot};

% Network
\node[comp, below=2mm of net.north west, anchor=north west, xshift=5mm] (uart) {UART Bridge};
\node[comp, right=4mm of uart] (mqtt) {MQTT Client};
\node[comp, right=4mm of mqtt] (httpc) {HTTP Client};

% Perception
\node[comp, below=2mm of perc.north west, anchor=north west, xshift=5mm] (pir) {PIR Sensor};
